...
The runt uses [mkcert](https://github.com/FiloSottile/mkcert) to generate locally-trusted certificates. It creates `login-key.pem` and `login.pem` for `login.coinflipper.local`.
